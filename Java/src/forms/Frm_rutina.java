...
/*-----------------------------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------------------------*/  
    ...
    public Frm_rutina() {
        ...
        this.txt_nivel1.setDocument(new Validar(this.txt_nivel1,15));
        cargarRutina();
 ...
 ------------------------------------------------------------------------------------------*/
    ...
    private void initComponents() {
        ...
        txt_nivel1 = new javax.swing.JTextField();
        ...
        jLabel26.setText("Rutinas");
        jPanel1.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 30, 90, -1));
        ...
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 600, 10));
        ...
        jPanel1.add(btn_eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 270, 100, 40));

        txt_nivel1.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        txt_nivel1.setForeground(new java.awt.Color(110, 110, 110));
        txt_nivel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(202, 202, 202), 1, true));
        txt_nivel1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_nivel1ActionPerformed(evt);
            }
        });
        txt_nivel1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txt_nivel1KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_nivel1KeyTyped(evt);
            }
        });
        jPanel1.add(txt_nivel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, 180, 30));
        ...
        jPanel1.add(btn_guardar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, 100, 40));
        ...
        jPanel1.add(btn_editar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 270, 100, 40));
        ...
        jPanel1.add(btn_cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 340, 100, 40));
...
/*-----------------------------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------------------------*/   
    ...
    private void txt_nivel1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_nivel1KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_nivel1KeyTyped

    private void txt_nivel1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_nivel1KeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_nivel1KeyReleased

    private void txt_nivel1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_nivel1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_nivel1ActionPerformed
 ...
 ------------------------------------------------------------------------------------------*/      
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
           if(txt_nivel1.getText().length() > 0 && txt_ruta.getText().length()>0){
            
             
                
                //llamamos al metodo insertar rutina y le enviamos el nivel  imagen y el largo de la img
                rutina.insertarRutina(txt_nivel1.getText(), inputImage, longBytes);
                cargarRutina();
 ...
 ------------------------------------------------------------------------------------------*/     
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if(txt_nivel1.getText().length() > 0 && txt_ruta.getText().length()>0){
                ...
                //llamamos al metodo insertar rutina y le enviamos el nivel  imagen y el largo de la img
                rutina.actulizarRutina(txt_nivel1.getText(), inputImage, longBytes);
                cargarRutina();
...
//        desactivagenerador();
        ...
        try {
            ...
            this.txt_nivel1.setText(tabla_rutina.getValueAt(fila, 1).toString());
    ...
    private javax.swing.JTextField txt_nivel1;
